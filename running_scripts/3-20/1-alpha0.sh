set -x
pip install math verify --no-build-isolation --link-mode=copy
...
EXPERIMENT_NAME=alpha_${ALPHA}_think_sample_${N_SAMPLE_TIME}
#MODEL_NAME=extrop/Qwen2.5-Math-7B-Instruct
SAVE_LOCAL_DIR=${SAVE_LOCAL_DIR_PREFIX}/${PROJECT_NAME}/${EXPERIMENT_NAME}
...
TASK_NAMES_EVAL=("orz_aime2024" "orz_gpqa_diamond" "orz_math500")
...
echo "Combined tasks for evaluation: ${TASK_NAMES_EVAL[@]}"
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.test_sample_n=${N_SAMPLE_TIME} \
