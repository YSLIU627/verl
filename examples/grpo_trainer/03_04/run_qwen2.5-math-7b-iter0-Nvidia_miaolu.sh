...
#END_IDX=2000
optimism_coeff=10.0
optimistic_actor=True
LOCAL_DATA_PATH=data
MODEL_NAME=Qwen/Qwen2.5-Math-7B
SAVE_LOCAL_DIR_PREFIX=/scratch/m000069/miaolu/checkpoints
PROJECT_NAME=Qwen2.5-Math-7B-GRPO-MEX
EXPERIMENT_NAME=grpo_mex_${optimistic_actor}_${optimism_coeff}_iter0_math_dataset
...
python3 -m verl.trainer.main_ppo \
    ...
    data.custom_temp_dir=/projects/m000069/miaolu/tmp/ray \
