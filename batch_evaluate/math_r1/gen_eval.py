...
def main():
    ...
    NUM_SAMPLES = 1       # Number of completions per prompt
    NUM_PROMPTS = 1  # Process only the first 100000 examples from the dataset
    ...
    #p#rint(f"? Dataset uploaded successfully: {NEW_DATASET_NAME}")
def eval():
    pass
